    ...
    <div class="row container d-flex justify-content-center">
      <div class="col-md-6">
        <div class="card card-bordered">
          ...
          echo "<form id='send-msg' class='text-center' action='send_msg.php?id=$id' method='POST'> </form>"
          ...
          <button class="btn btn-primary m-2" form="send-msg" value="May I know more details?" name="msg-txt"> May I know more details? </button>
          <button class="btn btn-primary m-2" form="send-msg" value="Price can be less?" name="msg-txt"> Price can be less?</button>
          <button class="btn btn-primary m-2" form="send-msg" value="Is this product authentic?" name="msg-txt"> Is this product authentic? </button>
