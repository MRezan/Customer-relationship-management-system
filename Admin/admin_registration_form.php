...
<head>
  ...
  <link rel="stylesheet" href="./styles/admin_registration.css">
      ...
      <div class="form-holder">
        <div class="form-content">
          <div class="form-items">
            ...
            <form method="POST" action="admin_registration.php" enctype="multipart/form-data">
              ...
              <div class="form-button mt-3 text-center">
                <button  id="submit" type="submit" class="btn btn-success px-5">Register</button>
              </div>
